...
const MISSION_ORDER = ['dropper', 'gosuslugi', 'klad', 'terror', 'bully'];
...
function startMission(missionId) {
  ...
  // Count max possible score for this mission
...
function finishMission(missionId) {
  ...
  if (curIdx < MISSION_ORDER.length - 1) {
    ...
    // Last mission - show final results button
    nextBtn.style.display = 'inline-block';
